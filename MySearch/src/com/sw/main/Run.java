...
import com.sw.puzzle.EightPuzzle;
import com.sw.puzzle.Puzzle;
import com.sw.search.Astar;
import com.sw.search.BFS;
import com.sw.search.DepthFirstSearch;
import com.sw.search.GreedyBestFirstSearch;
import com.sw.search.IDFS;
...
public class Run {
	...
	public static boolean run(){
		...
		case 2:
			...
			solution = Run.searchDFS(puzzle, goal2);
			 break;
		case 3:
			System.out.println("Please enter depth limit.");
			depthLimit = Integer.parseInt(in.nextLine());
			searchSelection = "Iterative Deepening";
			solution = Run.searchIDFS(puzzle, goal2, depthLimit);
			 break;
		case 4:
			searchSelection = "Greedy Best First Search";
			solution = Run.searchGreedy(puzzle, goal2);
			break;
		case 5:
			searchSelection = "A* Number of Tiles Incorrect";
			solution = Run.searchAstarTilesCorrect(puzzle, goal2, cmp);
			break;
		case 6:
			searchSelection = "A* Manhattan Distance";
			solution = Run.searchAstarManhattan(puzzle, goal2, cmp);
			break;
		}
	...
	/*
	 * Searches the problem for a solution based using Depth First Search.
	 * 
	 * @param puzzle initial state
	 * 
	 * @param goal goal state
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static List<Node> searchDFS(Puzzle puzzle, GoalTest<Puzzle> goal) {
		Problem<Puzzle> problem = new Problem<>(puzzle,
				new ActionFunctionImpl(), new ResultFunctionImpl(), goal);
		Search<Node, Puzzle> search = new DepthFirstSearch();
		List<Node> solution = search.search(problem);
		metrics = search.getMetrics();
		if (solution == null) {
			System.out.println("Solution cannot be found!");
	...
	/*
	 * Searches the problem for a solution based using Iterative deepening.
	 * 
	 * @param puzzle initial state
	 * 
	 * @param goal goal state
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static List<Node> searchIDFS(Puzzle puzzle, GoalTest<Puzzle> goal, int depthLimit) {
		Problem<Puzzle> problem = new Problem<>(puzzle,
				new ActionFunctionImpl(), new ResultFunctionImpl(), goal);
		Search<Node, Puzzle> search = new IDFS(depthLimit);
		List<Node> solution = search.search(problem);
		metrics = search.getMetrics();
		if (solution == null) {
			System.out.println("Solution cannot be found!");
	...
	/*
	 * Searches the problem for a solution based using Greedy best-first search.
	 * 
	 * @param puzzle initial state
	 * 
	 * @param goal goal state
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static List<Node> searchGreedy(Puzzle puzzle, GoalTest<Puzzle> goal) {
		Problem<Puzzle> problem = new Problem<>(puzzle
				,new ActionFunctionImpl(), new ResultFunctionImpl()
				,goal, new HeuristicTilesCorrect((Puzzle)goal));
		
		Search<Node, Puzzle> search = new GreedyBestFirstSearch();
		List<Node> solution = search.search(problem);
		metrics = search.getMetrics();
		if (solution == null) {
			System.out.println("Solution cannot be found!");
	...
	/*
	 * Searches the problem for a solution based using A*.
	 * 
	 * @param puzzle initial state
	 * 
	 * @param goal goal state
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static List<Node> searchAstarTilesCorrect(Puzzle puzzle
			, GoalTest<Puzzle> goal, Comparator<Node> cmp) {
		
		Problem<Puzzle> problem = new Problem<>(puzzle
				,new ActionFunctionImpl(), new ResultFunctionImpl()
				,goal, new HeuristicTilesCorrect((Puzzle)goal));
						
		Search<Node, Puzzle> search = new Astar(cmp);
		List<Node> solution = search.search(problem);
		metrics = search.getMetrics();
		if (solution == null) {
			System.out.println("Solution cannot be found!");
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static List<Node> searchAstarManhattan(Puzzle puzzle
			, GoalTest<Puzzle> goal, Comparator<Node> cmp) {
		Problem<Puzzle> problem = new Problem<>(puzzle
				,new ActionFunctionImpl(), new ResultFunctionImpl()
				,goal, new HeuristicManhattanDistance((Puzzle)goal));
